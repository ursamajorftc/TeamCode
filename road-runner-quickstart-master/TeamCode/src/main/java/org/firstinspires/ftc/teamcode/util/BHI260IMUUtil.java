...
/**
 * Various utility functions for the BHI260 IMU.
 */


public class  BHI260IMUUtil {
    ...
    /**
     * Remap BHI260 IMU axes and signs. For reference, the default order is {@link AxesOrder#XYZ}.
     * Call after {@link BHI260IMU#initialize(BHI260IMU.Parameters)}. Although this isn't
     ...
     * Reference the <a href="https://www.bosch-sensortec.com/media/boschsensortec/downloads/datasheets/bst-BHI260-ds000.pdf">BHI260 Datasheet</a> for details.
     *
     ...
     */
    public static void swapThenFlipAxes(BHI260IMU imu, AxesOrder order, AxesSigns signs) {
        try {
            ...
            imu.write8(BHI260IMU.Register.AXIS_MAP_CONFIG, axisMapConfig & 0x3F);

            // Write the AXIS_MAP_SIGN register
            imu.write8(BHI260IMU.Register.AXIS_MAP_SIGN, axisMapSigns & 0x07);

            // Switch back to the previous mode
            imu.write8(BHI260IMU.Register.OPR_MODE, imu.getParameters().mode.bVal & 0x0F);
     ...
     */
    public static void remapZAxis(BHI260IMU imu, AxisDirection direction) {
        switch (direction) {
            case POS_X:
     ...
     */
    @Deprecated
    public static void remapAxes(BHI260IMU imu, AxesOrder order, AxesSigns signs) {
